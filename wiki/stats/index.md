...
> Zdroje: [raw/2026-09-22-wizard](../../raw/2026-09-22-wizard.md), [raw/2026-09-22-zakladni-popis-hry](../../raw/2026-09-22-zakladni-popis-hry.md), [raw/2026-09-22-staty](../../raw/2026-09-22-staty.md), [raw/2026-09-22-staty-upresneni](../../raw/2026-09-22-staty-upresneni.md), [raw/2026-09-22-hit-cdr](../../raw/2026-09-22-hit-cdr.md) · Související: [classes](../classes/index.md), [talenty](../classes/talents.md), [equipment](../equipment/index.md)

Staty mají dvě úrovně: **Primary** (dávají bonusy do dalších statů) a **Secondary** (přímý efekt).
Každá [postava](../classes/index.md) má specifické základní hodnoty. Staty přicházejí z postavy,
[talentů](../classes/talents.md) a [vybavení](../equipment/index.md). Seznam není konečný.
...
| **Mastery** | **zvyšuje sílu pasivní schopnosti postavy** | pasivka je jiná pro každý spec, viz [schopnosti](../classes/abilities.md) a `classes/<postava>/abilities.md` |
...
### Mastery
Mastery je stat, který **zvyšuje sílu pasivní schopnosti postavy**. Každý
[spec](../classes/index.md#názvosloví-role-a-spec) má vlastní pasivku, takže stejný počet bodů znamená
u každé postavy něco jiného (Warden zvyšuje šanci na block, Bleed Dancer sílu bleedu…).
Přehled: [schopnosti](../classes/abilities.md), detaily v `classes/<postava>/abilities.md`.
...
|---|---|---|
| **Range** | podle **zbraně** | statická hodnota zbraně ([equipment](../equipment/index.md#range-zbraní)), případně výjimečně upraví talent |
...
|---|---|---|
| Mana Points | [Paladin](../classes/paladin/index.md) (bez Spiritu — Manu doplňuje bojem přes Divine Spark + itemy), [Wizard](../classes/wizard/index.md), [Summoner](../classes/summoner/index.md), [Shaman](../classes/shaman/index.md), [Cleric](../classes/cleric/index.md) | **Spirit** (% z max. za sekundu) + Resource Regen z itemů |
| Rage | [Warrior](../classes/warrior/index.md) | **+10 Rage za každý autoattack** (Spirit 0) |
| Energy | [Scout](../classes/scout/index.md), [Monk](../classes/monk/index.md) | **+5 Energy za 3 s** (Spirit 0) |
...
- Konkrétní pasivky, které Mastery zesiluje, jsou u jednotlivých postav (`classes/<postava>/abilities.md`).
...
- Pořadí výpočtu poškození: viz [combat/damage](../combat/damage.md).
