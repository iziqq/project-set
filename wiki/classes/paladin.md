...
## Role
Jediná postava se všemi třemi rolemi: **Tank**, **DPS**, **Healer**.
...
- Záměr: Paladin DPS **nemá být závislý na kritu**. Bonus je stálý a spouští ho každý útok.
...
- Počítá se **i z overhealu** (plná hodnota healu).
